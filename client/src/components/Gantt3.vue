<template>
  <div>
    ...
    <v-btn onclick="deleteRow()">Delete</v-btn>
    <br />
    ...
    />
    <br />
    <v-btn onclick="addTask()">Add task</v-btn>
    <v-btn onclick="addTasks()">Add tasks</v-btn><br />
    <v-btn onclick="destroy()">Destroy</v-btn><br />
    <v-btn onclick="changeOptions()">Change options</v-btn> -->
    ...
    <v-col>
      ...
      <!-- <v-btn @click="addTask" icon label="Add task"><v-icon color="green">mdi-plus</v-icon>Add</v-btn> -->
    </v-col>
  </div>
</template>
